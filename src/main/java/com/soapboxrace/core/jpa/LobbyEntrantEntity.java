...
@NamedQueries({ //
        ...
        @NamedQuery(name = "LobbyEntrantEntity.getVotes", query = "SELECT obj FROM LobbyEntrantEntity obj WHERE obj.nopuMode = 1 and obj.lobby = :lobby"),
        @NamedQuery(name = "LobbyEntrantEntity.getVoteStatus", query = "SELECT obj FROM LobbyEntrantEntity obj WHERE  WHERE obj.persona=:persona and obj.lobby=:lobby")
})
